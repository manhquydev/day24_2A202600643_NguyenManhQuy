...
def setup_presidio():
    ...
    # Configure Presidio to use the lightweight en_core_web_sm model instead of the heavy en_core_web_lg
    configuration = {
...
def pii_scan(text: str, analyzer=None, anonymizer=None) -> dict:
    ...
    PII_ENTITIES = {"VN_CCCD", "VN_PHONE", "PHONE_NUMBER", "EMAIL_ADDRESS", "PERSON"}
